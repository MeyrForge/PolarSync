...
import com.meyrforge.polarsync.feature_medication.presentation.MedicationViewModel
import com.meyrforge.polarsync.feature_sleep.presentation.components.SegmentedButtonComponent
...
@Composable
fun NewMedicationDialogComponent(
    viewModel: MedicationViewModel = hiltViewModel(),
    onDismiss: () -> Unit,
) {
    AlertDialog(
        icon = {
            Icon(Icons.Outlined.AddCircleOutline, contentDescription = "Agregar medicación")
        },
        title = {
...
@Composable
fun NewMedicationContent(viewModel: MedicationViewModel = hiltViewModel()) {
